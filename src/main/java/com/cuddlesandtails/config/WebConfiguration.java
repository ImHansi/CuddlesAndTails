...
public class WebConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.authorizeHttpRequests(auth -> {
            ...
            .requestMatchers("/pet").hasAnyAuthority("Admin","manager","receptionist","doctor","staff-member")
            .requestMatchers("/doctor").hasAnyAuthority("Admin","manager","receptionist","doctor","staff-member")
            .requestMatchers("/appointment").hasAnyAuthority("Admin","manager","receptionist","doctor","staff-member")
            .requestMatchers("/vaccinationrecord").hasAnyAuthority("Admin","manager","receptionist","doctor","staff-member")
            .requestMatchers("/consultation").hasAnyAuthority("Admin","manager","doctor","receptionist","staff-member")
            .requestMatchers("/announcement").hasAnyAuthority("Admin","manager","receptionist","staff-member")
            .requestMatchers("/order").hasAnyAuthority("Admin","manager")
            .requestMatchers("/vaccine").hasAnyAuthority("Admin","manager","doctor","staff-member")
