...
public class CardController {
    ...
    private final VaccinationrecordRepository vaccinationDao;

    CardController(PetRepository petDao, AppointmentRepository appointmentDao, VaccinationrecordRepository vaccinationDao) {
        this.petDao = petDao;
